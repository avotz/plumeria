...
gulp.task('js', function () {
  gulp.src([
     ...
     /*'./assets/js/vendor/grid.js',*/
      ...
      './assets/js/vendor/jquery.interactive_bg.js',
      './assets/js/main.js'
...
gulp.task('css', function () {
  gulp.src(['./assets/css/main.css','./assets/css/owl.carousel.css','./assets/css/owl.theme.default.css','./assets/css/animate.css','./assets/css/font-awesome.css'/*,'./fonts/eleganticons/et-icons.css'*/])
